...
<p>Please follow this link to validate your account with LoanRetriever: http://cs.wellesley.edu/~choef/current/mainCookie.php?confirmEmail=".mysql_insert_id().".</p>
